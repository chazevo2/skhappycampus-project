...
<script type="text/javascript">
	...
	window.onload = function() {
		$(".select_st").val("${b.getCategory()}").attr("selected", "selected");
	...
	<div class="sub-content">
		<div class="write-container">
			<div class="write-info">
				<h2 class="info-heading">게시글 수정</h2>
			</div>
				...
				<div id="con_body">
					<form id="edit" action="edit.do" method="post">
						<table class="tb_write" summary="글작성 테이블입니다.">
							...
							<tr>
								<th scope="row">글제목<input type="hidden" name="boardNum" value="${b.getBoardNum()}"></th>
								<td><input name="boardTitle" class="input_st" type="text" placeholder="글제목을 입력해주세요" title="글제목 입력" style="width:100%;" value="${b.getBoardTitle()}" required></td>
							</tr>
							<tr>
								<th scope="row">글내용</th>
								<td><textarea id="summernote" name="boardContent" required>${b.getBoardContent()}</textarea></td>
							</tr>
							</tbody>
						</table>
						...
						<p class="ta_c mt30">
							...
							<a class="writeBtn" href="#" onclick="doEdit()">글수정</a>
						</p>
					</form>
				</div>
			</div>
