...
<body>
	...
	<div class="sub-content">
		<div class="sub-container">
			<div class="sub-info">
				<h2 class="sub-heading">비밀번호 찾기</h2>
			</div>
					...
					<tbody>
						...
						<tr>
							...
							<td>
								...
								<input class="text_inpt" style="width: 100px;" type="text" name="memberTel" pattern="^[0-9]{3,4}$" required><span> - </span>
								<input class="text_inpt" style="width: 100px;" type="text" name="memberTel" pattern="^[0-9]{4}$" required>
							</td>
						</tr>
					</tbody>
				</table>
				<div style="width: 100%; margin-top: 20px;">
					<input type="button" class="normal_gray_center_btn" value="비밀번호 찾기" onclick="pwFind()" style="width: 100px;">
				</div>
			</div>
		</div>
	</div>
